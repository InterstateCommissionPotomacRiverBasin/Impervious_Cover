...
#==============================================================================
setwd("C:/Users/zsmith/Desktop/Impervious_Cover/Data/Final_Curr_Base_Landuse")
base.import <- read.csv("Base_Scen_Final_Curr_Base_Landuse.csv")
base.import[is.na(base.import)] <- 0
curr.import <- read.csv("Curr_Scen_Final_Curr_Base_Landuse.csv")
...
for (i in seq_along(nfiles)){
 ...
 #=============================================================================
  ...
  setwd("//Pike/data/Projects/ImperviousCover_802/Phase2/R_Output/1_10_17")
