...
huc.file <- "C:/Users/zsmith/Desktop/Impervious_Cover/Data/UNIKID_LRS_HUC12RfShds/UNIKID_LRS_HUC12RfShds_010517.csv"
huc12 <- read.csv(huc.file)
...
system.time(
  lapply(seq_along(nfiles), function(i) {
    print(paste("###############################", "HUC12:", names(nfiles[i]), "###############################"))
    print(paste("###############################", paste0(i, "/", length(nfiles)), "###############################"))
    setwd("//Pike/data/Projects/ImperviousCover_802/Phase2/EOF Flows")
    ...
    curr.list <- lapply(seq_along(sub.files), function(j) {
    ...
    setwd("//Pike/data/Projects/ImperviousCover_802/Phase2/R_Output/May_2017")
